...
export default class extends React.Component<IProps, {}> {
    ...
    public render() {
        return(
            <ul style={{display: 'flex', justifyContent: 'space-around', alignContent: 'space-between', listStyle: 'none', boxShadow: '0px 5px 20px 0px rgba(0,0,0,0.4)', position: 'fixed', bottom: '0', width: '100%', height: '50px', backgroundColor: 'rgba(255, 255, 255, 0.5', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)'}}>
                ...
                <li className={this.props.mobileMenu.tabState === 'tipping'? 'active' : 'inactive'} style={{textAlign: 'center', fontSize: '10px', display: 'flex'}}><button><span style={{display:'block'}}><FontAwesomeIcon icon={faMoneyBill} style={{width: '20px', height: '20px'}} /></span>Tipping</button></li>
                <li className={this.props.mobileMenu.tabState === 'works'? 'active' : 'inactive'} style={{textAlign: 'center', fontSize: '10px', display: 'flex'}}><button><span style={{display:'block'}}><FontAwesomeIcon icon={faPaintBrush} style={{width: '20px', height: '20px'}} /></span>Works</button></li>
